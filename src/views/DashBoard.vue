<template>
  ...
  >
    <section v-if="isAdmin" class="h-[70vh] text-center px-4 flex flex-col justify-between items-center">
      <div class="w-full h-fit mt-4 items-center justify-center space-x-8 md:flex">
        <RouterLink
        ...
        >
          <ListIcon
              class="block mr-4 h-10 stroke-2 stoke-gray-500"
          />
          <br />
          <span class="text-xl font-bold mt-8"
          >Services</span
          >
        </RouterLink>
        <RouterLink
        ...
        >
          <EmployeesIcon
              class="mr-4 h-[40px] stroke-2 stoke-gray-500"
          />
          <br />
