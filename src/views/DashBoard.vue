<template>
  <div
    class="min-h-[70vh] w-full text-center px-4 flex justify-center items-center"
  >
    <section
      v-if="false"
      class="w-full max-w-screen-xl px-4 space-x-8 grid grid-cols-4 lg:px-0"
    >
      <DashboardButton
    ...
    <section
      v-else-if="true"
      class="w-full max-w-screen-xl px-4 lg:px-0 flex justify-center"
    >
    <div class="w-1/2 space-x-8 grid grid-cols-2">
      <DashboardButton
