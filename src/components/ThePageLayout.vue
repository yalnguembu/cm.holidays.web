<template>
  <div class="h-screen w-screen">
    <TheMainNavbar
        :user="session"
        :items="session.isNull ? [] : isAdmin ? adminNavBarItems : isHumanResource ? humanResourceNavBarItems : clientNavBarItems"
    />
    <main class="flex flex-col items-center">
      <div
          class="w-full p-4 md lg:max-w-screen-xl xl:max-w-screen-2xl lg:px-8"
      >
        <RouterView />
      </div>
    </main>
...
import {adminNavBarItems, humanResourceNavBarItems, clientNavBarItems} from "@/utils/menu";
